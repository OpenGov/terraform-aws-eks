...
| map_roles_count | The count of roles in the map_roles list. Note: this is a workaround for a known issue with passing lists in terraform as variables | string | `0` | no |
...
| map_users_count | The count of roles in the map_users list. Note: this is a workaround for a known issue with passing lists in terraform as variables | string | `0` | no |
